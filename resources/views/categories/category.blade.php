...
<form class="text-center border border-light p-5" method="POST" action="{{url('/addCategory')}}">
    ...
    <input type="category" id="category" class="form-control mb-5" placeholder="Enter New Notice Category" name="category" value="{{ old('category') }}" required autofocus>
